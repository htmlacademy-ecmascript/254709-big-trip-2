...
import { humanizeTaskDueDate, getDuration } from '../util.js';
import dayjs from 'dayjs';

function createWaypointContentTemplate(waypoint, offers, destination) {
...
export default class WaypointContentView {
  ...
  getTemplate() {
    return createWaypointContentTemplate(this.waypoint, this.offers, this.destination);
  }
